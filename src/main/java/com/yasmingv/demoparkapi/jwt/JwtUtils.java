...
public class JwtUtils {
    ...
    public static final String JUST_BEARER = "Bearer ";

    public static final String JUST_AUTHORIZATION = "Authorization";
   ...
   private static String refactorToken(String token){
        if (token.contains(JUST_BEARER)){
            return token.substring(JUST_BEARER.length());
        }
        return token;
   }
}