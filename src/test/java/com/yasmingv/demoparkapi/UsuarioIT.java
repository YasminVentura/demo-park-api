package com.yasmingv.demoparkapi;
...
public class UsuarioIT {
    ...
    @Test
    public void criarUsuario_ComUsernameEPasswordValidos_RetornarUsuarioCriadoComStatus201() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("toby@gamil.com");
    ...
    @Test
    public void criarUsuario_ComUsernamerRepetido_RetornarErrorMessageComStatus409() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void buscarUsuario_ComId_RetornarUsuarioComStatus200() {
        UsuarioResponseDto responseBody = testClient
                .get()
    ...
    public void editarSenha_ComDadosValidos_RetornarStatus204() {
        testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("666333", "123456", "123456"))
                .exchange()
    ...
    public void editarSenha_ComCamposInvalidos_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("66633", "12345", "12345"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("6663339", "1234567", "1234567"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void editarSenha_ComSenhaInvalidas_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("666333", "123456", "000000"))
                .exchange()
